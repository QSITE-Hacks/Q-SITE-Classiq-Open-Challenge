...
// Creation timestamp: 2024-09-26T03:03:47.565660+00:00
// Random seed: 1112532146
...
gate prep_ancilla_0_statepreparation_rygate_2 q0,q1 {
  ...
  ry(-0.38759668665518077) q0;
  prep_ancilla_0_statepreparation_rygate_2_mcx_0 q1,q0;
  ry(0.38759668665518077) q0;
}

gate prep_ancilla_0_statepreparation q0,q1 {
  ry(0.604502754841415) q1;
...
gate cccircuit_178902 q0,q1,q2 {
}
...
gate mcx_hybrid_gray_code_maslov15_140124100070160 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate operate_iteration_2_rzgate_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_140124100070160 q0,q1,q2;
}
