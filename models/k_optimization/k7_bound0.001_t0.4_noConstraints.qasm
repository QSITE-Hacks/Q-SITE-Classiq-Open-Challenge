...
// Creation timestamp: 2024-09-26T03:02:13.384899+00:00
// Random seed: 3283878260
...
gate prep_ancilla_0_statepreparation_rygate_1 q0,q1 {
  ...
  ry(-0.24919405373324854) q0;
  prep_ancilla_0_statepreparation_rygate_1_mcx_0 q1,q0;
  ry(0.24919405373324854) q0;
}

gate mcx_hybrid_gray_code_maslov15_140054423720272 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054426396240_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054423720272 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_0_statepreparation_rygate_2_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054426396240_o0 q0,q1,q2;
}
...
gate mcx_hybrid_gray_code_maslov15_140053927691984 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o1 q0,q1,q2 {
  x q1;
  mcx_hybrid_gray_code_maslov15_140053927691984 q0,q1,q2;
  x q1;
}
...
gate mcx_hybrid_gray_code_maslov15_140054432181456 q0,q1,q2,q3,q4 {
  r1tof q0,q1,q4;
  ccx q4,q2,q3;
  r1tof q0,q1,q4;
}
...
gate operate_iteration_0_igate_mcx_0 q0,q1,q2,q3,q4 {
  mcx_hybrid_gray_code_maslov15_140054432181456 q0,q1,q2,q3,q4;
}

gate ccircuit_672001 q0,q1 {
}

gate operate_iteration_0_igate q0,q1,q2,q3,q4,q5 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4,q5;
  ccircuit_672001 q4,q0;
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4,q5;
}
...
gate mcx_hybrid_gray_code_maslov15_140054810904080 q0,q1,q2,q3 {
  mcx q0,q1,q2,q3;
}

gate operate_iteration_1_compose_mcx_1 q0,q1,q2,q3 {
  mcx_hybrid_gray_code_maslov15_140054810904080 q0,q1,q2,q3;
}
...
gate operate_iteration_1_compose q0,q1,q2,q3,q4,q5 {
  ...
  operate_iteration_1_compose_mcx_1 q1,q2,q3,q5;
}
...
gate operate_iteration_2_rzgate q0,q1,q2,q3,q4 {
  rz(-pi) q0;
  operate_iteration_1_compose_mcx_1 q1,q2,q3,q0;
  rz(-pi) q0;
...
gate operate_iteration_5_compose q0,q1,q2,q3,q4,q5 {
  operate_iteration_1_compose_mcx_1 q1,q2,q3,q4;
...
gate main_operate q0,q1,q2,q3,q4,q5 {
  ...
  operate_iteration_7 q0,q1,q2,q3,q4;
}
...
gate mcx_hybrid_gray_code_maslov15_140054423269904 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054423272528_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054423269904 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_1_qinverse_mcx_0_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054423272528_o0 q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_140054423272720 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054423260496_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054423272720 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_1_qinverse_mcx_1_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054423260496_o0 q0,q1,q2;
}
