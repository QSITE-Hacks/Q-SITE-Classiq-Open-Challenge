...
// Creation timestamp: 2024-09-26T03:02:43.707573+00:00
// Random seed: 500408136
...
gate mcx_hybrid_gray_code_maslov15_139643926084880 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_139644931976784_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_139643926084880 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_0_statepreparation_rygate_2_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_139644931976784_o0 q0,q1,q2;
}
...
gate mcx_hybrid_gray_code_maslov15_139644172522640 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o1 q0,q1,q2 {
  x q1;
  mcx_hybrid_gray_code_maslov15_139644172522640 q0,q1,q2;
  x q1;
}
...
gate mcx_hybrid_gray_code_maslov15_139643928528592 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o2 q0,q1,q2 {
  x q0;
  mcx_hybrid_gray_code_maslov15_139643928528592 q0,q1,q2;
  x q0;
}
...
gate mcx_hybrid_gray_code_maslov15_139644206377872 q0,q1,q2,q3 {
  mcx q0,q1,q2,q3;
}

gate operate_iteration_0_igate_mcx_0 q0,q1,q2,q3 {
  mcx_hybrid_gray_code_maslov15_139644206377872 q0,q1,q2,q3;
}

gate ccircuit_1151767 q0,q1 {
}
...
gate mcx_hybrid_gray_code_maslov15_139643988577552 q0,q1,q2,q3,q4 {
  r1tof q0,q1,q4;
  ccx q4,q2,q3;
  r1tof q0,q1,q4;
}

gate operate_iteration_0_igate_mcx_1 q0,q1,q2,q3,q4 {
  mcx_hybrid_gray_code_maslov15_139643988577552 q0,q1,q2,q3,q4;
}

gate operate_iteration_0_igate q0,q1,q2,q3,q4,q5 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
  ccircuit_1151767 q4,q0;
  operate_iteration_0_igate_mcx_1 q1,q2,q3,q4,q5;
}
...
gate operate_iteration_2_rzgate q0,q1,q2,q3,q4 {
  rz(-pi) q0;
  operate_iteration_0_igate_mcx_1 q1,q2,q3,q0,q4;
  rz(-pi) q0;
  operate_iteration_0_igate_mcx_1 q1,q2,q3,q0,q4;
  rz(2*pi) q0;
}
...
gate operate_iteration_3_compose q0,q1,q2,q3,q4 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
  operate_iteration_3_compose_compose_aux_control_name q4,q0;
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
}
...
gate operate_iteration_3 q0,q1,q2,q3,q4 {
  operate_iteration_3_inplace_prepare_int_0 q1,q2,q3;
  operate_iteration_3_compose q0,q1,q2,q3,q4;
...
gate operate_iteration_4_igate q0,q1,q2,q3,q4,q5 {
  operate_iteration_0_igate_mcx_1 q1,q2,q3,q5,q4;
  ccircuit_1151767 q5,q0;
  operate_iteration_0_igate_mcx_1 q1,q2,q3,q5,q4;
}
...
gate operate_iteration_6_rzgate q0,q1,q2,q3 {
  rz(-pi) q0;
...
gate operate_iteration_6 q0,q1,q2,q3 {
  operate_iteration_6_inplace_prepare_int_0 q1,q2,q3;
  operate_iteration_6_rzgate q0,q1,q2,q3;
...
gate mcx_hybrid_gray_code_maslov15_139643827029392 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_139643827038864_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_139643827029392 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_3_qinverse_mcx_0_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_139643827038864_o0 q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_139643827037328 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_139643827034896_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_139643827037328 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_3_qinverse_mcx_1_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_139643827034896_o0 q0,q1,q2;
}
