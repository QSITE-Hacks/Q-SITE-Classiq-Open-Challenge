...
// Creation timestamp: 2024-09-26T03:02:05.830969+00:00
// Random seed: 3442225311
...
gate mcx_hybrid_gray_code_maslov15_140494059838160 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140494059840976_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140494059838160 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_0_statepreparation_rygate_2_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140494059840976_o0 q0,q1,q2;
}
...
gate mcx_hybrid_gray_code_maslov15_140494020862864 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o1 q0,q1,q2 {
  x q1;
  mcx_hybrid_gray_code_maslov15_140494020862864 q0,q1,q2;
  x q1;
}
...
gate mcx_hybrid_gray_code_maslov15_140494028186704 q0,q1,q2,q3 {
  mcx q0,q1,q2,q3;
}

gate operate_iteration_0_igate_mcx_0 q0,q1,q2,q3 {
  mcx_hybrid_gray_code_maslov15_140494028186704 q0,q1,q2,q3;
}

gate ccircuit_24650 q0,q1 {
}

gate operate_iteration_0_igate q0,q1,q2,q3,q4 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
  ccircuit_24650 q4,q0;
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
}
...
gate mcx_hybrid_gray_code_maslov15_140494037656208 q0,q1,q2,q3,q4 {
  r1tof q0,q1,q4;
  ccx q4,q2,q3;
  r1tof q0,q1,q4;
}
...
gate operate_iteration_2_rzgate_mcx_0 q0,q1,q2,q3,q4 {
  mcx_hybrid_gray_code_maslov15_140494037656208 q0,q1,q2,q3,q4;
}

gate operate_iteration_2_rzgate q0,q1,q2,q3,q4 {
  rz(-pi) q0;
  operate_iteration_2_rzgate_mcx_0 q1,q2,q3,q0,q4;
  rz(-pi) q0;
...
gate operate_iteration_4_igate q0,q1,q2,q3,q4 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
  ccircuit_24650 q4,q0;
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
}
...
gate operate_iteration_4 q0,q1,q2,q3,q4 {
  operate_iteration_4_inplace_prepare_int_0 q1,q2,q3;
  operate_iteration_4_igate q0,q1,q2,q3,q4;
...
gate operate_iteration_5_compose q0,q1,q2,q3,q4,q5 {
  operate_iteration_2_rzgate_mcx_0 q1,q2,q3,q5,q4;
...
gate main_operate q0,q1,q2,q3,q4,q5 {
  ...
  operate_iteration_4 q0,q1,q2,q3,q4;
...
gate mcx_hybrid_gray_code_maslov15_140494055113552 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140494055127120_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140494055113552 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_1_qinverse_mcx_0_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140494055127120_o0 q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_140494029512336 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140494055119504_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140494029512336 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_1_qinverse_mcx_1_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140494055119504_o0 q0,q1,q2;
}
