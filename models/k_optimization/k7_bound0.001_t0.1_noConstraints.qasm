...
// Creation timestamp: 2024-09-26T03:01:48.157303+00:00
// Random seed: 4123639854
...
gate mcx_hybrid_gray_code_maslov15_140054414092048 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054414097744_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054414092048 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_0_statepreparation_rygate_2_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054414097744_o0 q0,q1,q2;
}
...
gate mcx_hybrid_gray_code_maslov15_140054404278992 q0,q1,q2,q3 {
  mcx q0,q1,q2,q3;
}

gate operate_iteration_0_igate_mcx_0 q0,q1,q2,q3 {
  mcx_hybrid_gray_code_maslov15_140054404278992 q0,q1,q2,q3;
}

gate ccircuit_671540 q0,q1 {
}

gate operate_iteration_0_igate q0,q1,q2,q3,q4 {
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
  ccircuit_671540 q4,q0;
  operate_iteration_0_igate_mcx_0 q1,q2,q3,q4;
}
...
gate mcx_hybrid_gray_code_maslov15_140053966539280 q0,q1,q2,q3,q4 {
  r1tof q0,q1,q4;
  ccx q4,q2,q3;
  r1tof q0,q1,q4;
}
...
gate operate_iteration_1_compose_mcx_1 q0,q1,q2,q3,q4 {
  mcx_hybrid_gray_code_maslov15_140053966539280 q0,q1,q2,q3,q4;
}
...
gate mcx_hybrid_gray_code_maslov15_140054815425040 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054805907152_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054815425040 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_0_qinverse_mcx_0_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054805907152_o0 q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_140054815321296 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140054425749840_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054815321296 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_0_qinverse_mcx_1_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140054425749840_o0 q0,q1,q2;
}
