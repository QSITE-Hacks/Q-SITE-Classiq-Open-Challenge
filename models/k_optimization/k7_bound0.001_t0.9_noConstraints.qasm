...
// Creation timestamp: 2024-09-26T03:02:52.699466+00:00
// Random seed: 2474276792
...
gate mcx_hybrid_gray_code_maslov15_140054404551440 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140053965730384_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140054404551440 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_0_statepreparation_rygate_2_mcx_0 q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140053965730384_o0 q0,q1,q2;
}
...
gate mcx_hybrid_gray_code_maslov15_140053932435280 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o1 q0,q1,q2 {
  x q1;
  mcx_hybrid_gray_code_maslov15_140053932435280 q0,q1,q2;
  x q1;
}
...
gate prep_ancilla_0_statepreparation_rygate_4 q0,q1 {
  ...
  ry(-0.15933393728799858) q0;
  prep_ancilla_0_statepreparation_rygate_4_mcx_0 q1,q0;
  ry(0.15933393728799858) q0;
}

gate mcx_hybrid_gray_code_maslov15_140054428287760 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o2 q0,q1,q2 {
  x q0;
  mcx_hybrid_gray_code_maslov15_140054428287760 q0,q1,q2;
  x q0;
}
...
gate mcx_hybrid_gray_code_maslov15_140054405374288 q0,q1,q2,q3 {
  mcx q0,q1,q2,q3;
}

gate operate_iteration_0_igate_mcx_0 q0,q1,q2,q3 {
  mcx_hybrid_gray_code_maslov15_140054405374288 q0,q1,q2,q3;
}

gate ccircuit_672464 q0,q1 {
}
...
gate mcx_hybrid_gray_code_maslov15_140054810906832 q0,q1,q2,q3,q4 {
  r1tof q0,q1,q4;
  ccx q4,q2,q3;
  r1tof q0,q1,q4;
}
...
gate mcx_hybrid_gray_code_maslov15_140053925774608 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140053925782224_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140053925774608 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_3_qinverse_mcx_0_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140053925782224_o0 q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_140053925789264 q0,q1,q2 {
  ccx q0,q1,q2;
}

gate mcx_hybrid_gray_code_maslov15_o0_140053925782864_o0 q0,q1,q2 {
  x q0;
  x q1;
  mcx_hybrid_gray_code_maslov15_140053925789264 q0,q1,q2;
  x q0;
  x q1;
}

gate prep_ancilla_1_statepreparation_qinverse_rygate_3_qinverse_mcx_1_qinverse q0,q1,q2 {
  mcx_hybrid_gray_code_maslov15_o0_140053925782864_o0 q0,q1,q2;
}
